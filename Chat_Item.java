...
public class Chat_Item extends javax.swing.JLayeredPane {
    ...
    public void sendSuccess() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/jerin/icon/tick.png")));
        }
    }

    public void seen() {
        if (label != null) {
            label.setIcon(new ImageIcon(getClass().getResource("/com/jerin/icon/double_tick.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        txt = new com.jerin.swing.JIMSendTextPane();
    ...
    private com.jerin.swing.JIMSendTextPane txt;
